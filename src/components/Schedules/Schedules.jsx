        ...
        <div className="content-page">
            ...
            <div className="schedule-list-content">
                <div className="schedule-list-wrap">
                    <div className="schedule-load" style={{ minHeight: '137.5px', opacity: 1 }}>
                        <div
                            className="schedule-item"
                            cine-id="d8b730d2-b30a-4127-aae3-096aec822f33"
                            cine-name="ÁC QUỶ MA SƠ 2 (T18)"
                        >
                            <div className="film-item cl-org t-2d">
                                <a href="https://cinestar.com.vn/phim/d8b730d2-b30a-4127-aae3-096aec822f33">
                                    <div className="film-item-pic">
                                        <img
                                            src="https://cinestar.com.vn/pictures/Cinestar/09-2023/the-nun-ii.jpg"
                                    ...
                                    <div className="film-item-txt">
                                        ...
                                        <p>
                                            Bốn năm sau sự kiện tại tu viện St. Carta, sơ Irene trở lại một lần nữa để
                                            đối mặt với thế lực hắc ám của ác quỷ ma sơ Valak.
                                        </p>
                                    </div>
                                </a>
                                <div className="film-item-type">
                                    <span className="icon-2d" />
                                    {/*<span class="icon-am3d"></span><span class="icon-3d"></span>*/}
                                </div>
                            </div>
                            <div className="schedule">
                                <div className="row">
                                    <div className="row-date" data-date="08/09/2023">
                                        <span>
                                            08/09
                                            <br />
                                            2023
                        ...
                        <div
                            className="schedule-item"
                            cine-id="50982e83-0bb1-4c1d-a030-5761e5e9a65c"
                            cine-name="TÌNH BẠN DIỆU KỲ 2D LT (P)"
                        >
                            <div className="film-item cl-ppl-dark t-2d">
                                <a href="https://cinestar.com.vn/phim/50982e83-0bb1-4c1d-a030-5761e5e9a65c">
                                    <div className="film-item-pic">
                                        <img
                                            src="https://cinestar.com.vn/pictures/Cinestar/09-2023/tinh-ban-dieu-ky.jpg"
                                    ...
                                    <div className="film-item-txt">
                                        ...
                                        <p>
                                            Một cuộc phiêu lưu kỳ thú tại thành phố New York hoa lệ của chú rối bỏ trốn
                                            với trí tưởng tượng vô biên - Don và món đồ chơi thú nhồi bông bị bỏ rơi -
                                            DJ Doggy Dog tại Công viên Trung tâm. Trải qua bao buồn vui, thăng trầm,
                                            cuộc phiêu lưu này đã gắn kết hai mảnh đời dường như chẳng liên quan đến
                                            nhau ấy, tạo nên một câu chuyện đẹp về tình bạn.
                                        </p>
                                    </div>
                                </a>
                                <div className="film-item-type">
                            ...
                            <div className="schedule">
                                <div className="row">
                                    <div className="row-date" data-date="06/09/2023">
                                        <span>
                                            06/09
                                            <br />
                                            2023
                                ...
                                <div className="row">
                                    <div className="row-date" data-date="07/09/2023">
                                        <span>
                                            07/09
                                            <br />
                                            2023
                        ...
                        <div
                            className="schedule-item"
                            cine-id="a525bf6a-e9b9-4044-8a89-5b167f96650c"
                            cine-name="THIỆN ÁC ĐỐI ĐẦU 3 (T18)"
                        >
                            <div className="film-item cl-ppl t-2d">
                                <a href="https://cinestar.com.vn/phim/a525bf6a-e9b9-4044-8a89-5b167f96650c">
                                    <div className="film-item-pic">
                                        <img
                                            src="https://cinestar.com.vn/pictures/Cinestar/09-2023/thien-ac-doi-dau-3.jpg"
                                    ...
                                    <div className="film-item-txt">
                                        ...
                                        <p>
                                            Robert McCall chuyển đến sinh sống tại miền Nam nước Ý nhưng phát hiện ra
                                            bạn bè của mình bị một tổ chức mafia ở địa phương kiểm soát. Khi tính mạng
                                            của họ bị đe dọa, ông buộc phải quay trở lại con đường sát thủ để bảo vệ bạn
                                            bè.
                                        </p>
                                    </div>
                                </a>
                        ...
                        <div
                            className="schedule-item"
                            cine-id="af6013dc-5e12-4f92-8ac9-5ee43f92f96f"
                            cine-name="BỘ ĐÔI BÁO THỦ (T16)"
                        >
                            <div className="film-item cl-pnk t-2d">
                                <a href="https://cinestar.com.vn/phim/af6013dc-5e12-4f92-8ac9-5ee43f92f96f">
                                    <div className="film-item-pic">
                                        <img
                                            src="https://cinestar.com.vn/pictures/Cinestar/09-2023/bo-doi-bao-thu1.jpg"
                                    ...
                                    <div className="film-item-txt">
                                        ...
                                        <p>
                                            Bộ Đôi Báo Thủ xoay quanh hành trình giải cứu một đồng nghiệp bị mất tích ở
                                            Lebanon 20 tháng trước của nhà ngoại giao Min-jun (Ha Jung-woo). Là một
                                            nhiệm vụ không chính thức rất nguy hiểm, nhưng Min-jun vẫn chấp nhận bởi anh
                                            khao khát được thăng chức tới Mỹ sau 5 năm chôn chân tại Vụ Trung Đông, Bộ
                                            Ngoại giao. Ngay khi đặt chân xuống sân bay Lebanon, Min-jun đã bị truy đuổi
                                            ráo riết bởi cảnh sát địa phương và cả bọn xã hội đen, khiến anh bất đắc dĩ
                                            phải dựa vào sự giúp đỡ của người Hàn Quốc duy nhất tại đây - tài xế Pan-su
                                            (Ju Ji-hoon).
                                        </p>
                                    </div>
                                </a>
                        ...
                        <div
                            className="schedule-item"
                            cine-id="6594de8a-d72d-449a-8d5f-9f08ba8cee56"
                            cine-name="CHẠM VÀO HẠNH PHÚC (K)"
                        >
                            <div className="film-item cl-org t-2d">
                                <a href="https://cinestar.com.vn/phim/6594de8a-d72d-449a-8d5f-9f08ba8cee56">
                                    <div className="film-item-pic">
                                        <img
                                            src="https://cinestar.com.vn/pictures/Cinestar/09-2023/cham-vao-cam-xuc.jpg"
                                    ...
                                    <div className="film-item-txt">
                                        ...
                                        <p>
                                            Chạm Vào Hạnh Phúc là bộ phim điện ảnh Việt Nam nói về cuộc hành trình tìm
                                            kiếm hạnh phúc của cuộc sống, tình yêu và khát vọng, khai thác những tình
                                            cảm gia đình đầy ý nghĩa. Cùng xem lịch chiếu Chạm Vào Hạnh Phúc mới nhất,
                                            giá vé Chạm Vào Hạnh Phúc chi tiết tại rạp. Review phim và mua vé xem phim
                                            Chạm Vào Hạnh Phúc tại các Rạp Chiếu Phim.
                                        </p>
                                    </div>
                                </a>
                                <div className="film-item-type">
                        ...
                        <div
                            className="schedule-item"
                            cine-id="cbdba331-5e8b-488d-9c15-e69c8aeb0279"
                            cine-name="BẾN PHÀ XÁC SỐNG (T16)"
                        >
                            <div className="film-item cl-ppl-dark t-2d">
                                <a href="https://cinestar.com.vn/phim/cbdba331-5e8b-488d-9c15-e69c8aeb0279">
                                    <div className="film-item-pic">
                                        <img
                                            src="https://cinestar.com.vn/pictures/Cinestar/09-2023/ben-pha-xac-song1.jpg"
                                    ...
                                    <div className="film-item-txt">
                                        ...
                                        <p>
                                            Nội dung “Bến Phà Xác Sống” xoay quanh cuộc chạy trốn của nhóm người của
                                            Công (Huỳnh Đông) khỏi sự bùng phát của dịch bệnh và cố gắng chạy đến chuyến
                                            phà cuối cùng ở vùng hạ lưu sông Mekong. Thế nhưng, trong quá trình chạy
                                            trốn, họ một lần thất lạc khi xuất hiện sự biến chất và phá bĩnh của Diễm
                                            (Ốc Thanh Vân) khiến nhóm người buộc phải tách ra. Và cuộc tấn công của
                                            Zombie đổ bộ cù lao, đối mặt giữa sống và chết, các nhân vật nhận ra không
                                            phải dịch bệnh, chính sự tồn tại của tính ích kỷ và oán hận mới là thứ đẩy
                                            họ vào những thử thách sống còn.
                                        </p>
                                    </div>
                                </a>
                                <div className="film-item-type">
                        ...
                        <div
                            className="schedule-item"
                            cine-id="6e5c0efe-6afa-42b1-9bb6-10c16872d5ec"
                            cine-name="HÀM TỬ THẦN (T18)"
                        >
                            <div className="film-item cl-ppl t-2d">
                                <a href="https://cinestar.com.vn/phim/6e5c0efe-6afa-42b1-9bb6-10c16872d5ec">
                                    <div className="film-item-pic">
                                        <img
                                            src="https://cinestar.com.vn/pictures/Cinestar/08-2023/ham-tu-than.png"
                                            alt="HÀM TỬ THẦN (T18)"
                                        />
                                    </div>
                                    <div className="film-item-txt">
                                        ...
                                        <p>
                                            Trên chuyến hành trình xuyên biển đoàn tụ gia đình, một cơn bão buộc Naomi
                                            rời khỏi lộ trình và vướng vào phi vụ nguy hiểm dưới lòng đại dương. Nhiệm
                                            vụ khó thành, hàm tử thần chực chờ nuốt chửng, liệu Naomi có thể thoát khỏi
                                            biển máu!?
                                        </p>
                                    </div>
                                </a>
                        ...
                        <div
                            className="schedule-item"
                            cine-id="da4582f2-64af-42ca-91b3-4b23c29440ad"
                            cine-name="ĐỊA ĐÀNG SỤP ĐỔ (T16)"
                        >
                            <div className="film-item cl-pnk t-2d">
                                <a href="https://cinestar.com.vn/phim/da4582f2-64af-42ca-91b3-4b23c29440ad">
                                    <div className="film-item-pic">
                                        <img
                                            src="https://cinestar.com.vn/pictures/Cinestar/09-2023/dia-dang-sup-do.jpg"
                                    ...
                                    <div className="film-item-txt">
                                        ...
                                        <p>
                                            Sau trận động đất dữ dội, ở trung tâm Seoul chỉ còn lại một tòa nhà chung cư
                                            có thể đứng vững, được gọi là Khu căn hộ Hwang Gung. Thời gian trôi qua,
                                            những người bên ngoài bắt đầu đến đây để cố gắng thoát khỏi cái lạnh khắc
                                            nghiệt. Chẳng bao lâu, cư dân chung cư không thể đối phó với số lượng ngày
                                            càng tăng và khi cảm thấy mối đe dọa đối với sự sống còn của mình, họ quyết
                                            định ban hành một biện pháp đặc biệt
                                        </p>
                                    </div>
                                </a>
                                <div className="film-item-type">
                        ...
                        <div
                            className="schedule-item"
                            cine-id="18a2c270-002e-4946-a721-05cf8dc304d8"
                            cine-name="KẺ ẨN DANH (T18)"
                        >
                            <div className="film-item cl-org t-2d">
                                <a href="https://cinestar.com.vn/phim/18a2c270-002e-4946-a721-05cf8dc304d8">
                                    <div className="film-item-pic">
                                        <img
                                            src="https://cinestar.com.vn/pictures/Cinestar/08-2023/ke-an-danh-poster.jpg"
                                            alt="KẺ ẨN DANH (T18)"
                                        />
                                    </div>
                                    <div className="film-item-txt">
                                        ...
                                        <p>
                                            Chuyện kể về Lâm - người đàn ông chân chất có quá khứ bí mật, luôn đặt vợ
                                            con và hạnh phúc gia đình lên hàng đầu. Thế nhưng, cuộc sống yên bình của
                                            gia đình anh bỗng chốc bị đảo lộn. Lúc này, Lâm phải bảo vệ những điều mà
                                            anh yêu thương bằng mọi giá.
                                        </p>
                                    </div>
                                </a>
                                <div className="film-item-type">
                        ...
                        <div
                            className="schedule-item"
                            cine-id="a0d22936-c3ea-4906-b105-f6e414001660"
                            cine-name="3DCG! SHIN CẬU BÉ BÚT CHÌ 2D LT (P): ĐẠI CHIẾN SIÊU NĂNG LỰC SUSHI BAY"
                        >
                            <div className="film-item cl-ppl-dark t-2d">
                                <a href="https://cinestar.com.vn/phim/a0d22936-c3ea-4906-b105-f6e414001660">
                                    ...
                                    <div className="film-item-txt">
                                        ...
                                        <p>
                                            3DCG! Shin Cậu Bé Bút Chì: Đại Chiến Siêu Năng Lực ~Sushi Bay~ xoay quanh
                                            câu chuyện về hai nguồn sáng đặc biệt từ vũ trụ mang theo siêu năng lực đặc
                                            biệt tới Trái Đất. Một nguồn sáng tích cực “nhập” vào nhóc Shin, khiến cặp
                                            mông núng nính của cậu chàng trở nên nóng bỏng và có khả năng điều khiển
                                            những đồ vật xung quanh theo ý muốn.
                                        </p>
                                    </div>
                                </a>
                                <div className="film-item-type">
                        ...
                        <div
                            className="schedule-item"
                            cine-id="5b612727-452d-417a-b680-ea5194fa5019"
                            cine-name="GRAN TURISMO: TAY ĐUA CỰ PHÁCH (T13)"
                        >
                            <div className="film-item cl-ppl t-2d">
                                <a href="https://cinestar.com.vn/phim/5b612727-452d-417a-b680-ea5194fa5019">
                                    ...
                                    <div className="film-item-txt">
                                        ...
                                        <p>
                                            Nội dung bộ phim dựa trên câu chuyện có thật về Jann Mardenborough, một tay
                                            đua nổi tiếng tới từ Anh quốc. Vào năm 2011, anh đã đánh bại 90.000 đối thủ
                                            để trở thành nhà vô địch thứ ba, đồng thời là nhà vô địch trẻ tuổi nhất
                                            trong giải đấu GT Academy. Phần thưởng của Jann là cơ hội được đại diện cho
